...
import pandas as pd
from storage.r2_storage import get_storage
...
def test_spark_upload():
    """Test uploading Spark DataFrame to R2 (requires PySpark)"""
    print("=" * 60)
    ...
    try:
        ...
        # ]
        # columns = ['product_name', 'price', 'rating', 'reviews']

        df = spark.read.csv("/Users/mw-sanskar/Documents/sanskar/projects/EcommerceScrapper/scrape_results/millet_snacks_20260313_145516.csv")
